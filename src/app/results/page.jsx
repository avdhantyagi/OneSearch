...
export default function Page() {
    ...
    const prompt = encodeURIComponent('Here is the prompt you want to send')
    ...
    <div className='flex flex-col min-h-screen items-center max-w-[800px] min-w-[300px]'>
        ...
        <div className='grid w-[300px] sm:grid-cols-1 sm:min-w-[400px] md:min-w-[600px] lg:w-[800px] lg:grid:cols-2 gap-4 md:grid-cols-2 p-4 min-h-[50vh]'>
            <a href={'https://www.google.com/search?q='+query} target='_blank'><Card  type='Google' icon='/google.svg'/></a>
            <a href={'https://www.bing.com/search?form=&q='+query} target="_blank"><Card type='Bing' icon='bing.svg'/></a>
            <a href={'https://chat.openai.com/?model=gpt-4&q='+query} target="_blank"><Card2 type='ChatGPT' icon='chatgpt.png' title='ChatGpt'/></a>
            <a href={''+query}><Card /></a>
        </div>
    </div>
    )
